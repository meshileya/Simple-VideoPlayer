...
extension ControllerDelegate where Self:UIViewController {
    ...
    func showProgress (_ text: String = "Please wait...") {
        ...
        _ = label.anchor(activityIndicatorView.bottomAnchor, left: coverView.leftAnchor, bottom: nil, right: coverView.rightAnchor, topConstant: 5, leftConstant: 30, bottomConstant: 0, rightConstant: 30, widthConstant: 0, heightConstant: 0)
